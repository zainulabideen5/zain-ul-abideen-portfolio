...
function initSectionAnimations() {
    ...
    (function() {
  emailjs.init("EvDIku74d7kmidTzk"); // ← ضع المفتاح العام من EmailJS
})();

document.getElementById("contact-form").addEventListener("submit", function(e) {
  e.preventDefault();

  emailjs.sendForm("service_3ril85q", "template_g90jtq2", this)
    .then(() => {
      alert("Dn");
    }, (error) => {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        emailjs.sendForm(
            "service_3ril85q",   // Service ID من EmailJS
            "template_g90jtq2",  // Template ID من EmailJS
            this
        ).then(
            () => {
